...
//
$mail_sys = "redstar.hoshir@gmail.com";	// 管理者のメールアドレス
$from_name = "自営業　Redstar";	// メール送信者の表示
$from_mail = "redstar.hoshir@gmail.com";	// メール送信者のメールアドレス（返信先）
$user_mail = "Redstar＠お問い合わせメール";	// 利用者にメールを送る場合のメールアドレス項目
//---
$title = "お問い合わせフォーム";
...
if (!$footer) {
	$footer = "\n------------
自営業　Redstar
https://redstar-homepege.netlify.app/
------------
";
}
//	都道府県
